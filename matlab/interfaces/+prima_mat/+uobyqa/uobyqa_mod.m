classdef uobyqa_mod
    ...
    methods
        function [x, f_loc, nf_loc, xhist, fhist, info_loc] = uobyqa(~, calfun, x, varargin)
            ...
            addParameter(ipObj, 'gamma1', consts_obj.HALF);
            addParameter(ipObj, 'gamma2', consts_obj.TWO);
            ...
            [iprint_loc, maxfun_loc, maxhist_loc, ftarget_loc, rhobeg_loc, rhoend_loc, ~, ~, ~, ...
             ~, eta1_loc, eta2_loc, gamma1_loc, gamma2_loc] = ...
                preproc_obj.preproc(solver, n, iprint_loc, maxfun_loc, maxhist_loc, ftarget_loc, ...
                                    rhobeg_loc, rhoend_loc, 'eta1', eta1_loc, 'eta2', eta2_loc, ...
            ...
            if ismember('callback_fcn', ipObj.UsingDefaults)
                [x, nf_loc, f_loc, fhist_loc, xhist_loc, info_loc] = ...
                    uobyqb_obj.uobyqb(calfun, iprint_loc, maxfun_loc, eta1_loc, eta2_loc, ...
                                      ftarget_loc, gamma1_loc, gamma2_loc, rhobeg_loc, ...
