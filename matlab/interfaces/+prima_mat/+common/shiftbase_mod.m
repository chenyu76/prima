classdef shiftbase_mod
    ...
    methods
        ...
        function [xbase, xpt, bmat, hq] = ...
            ...
            sxpt = ...
                linalg_obj.matprod12(xopt, xpt) ...
                - consts_obj.HALF * xoptsq; % This one seems to work better numerically.
            ...
            bymat(:) = ...
                linalg_obj.matprod22(bmat(:, 1:npt), ymat.'); % BMAT(:, 1:NPT) is not updated yet.
            ...
            bmat(:, npt + 1:npt + n) = ...
                bmat(:, npt + 1:npt + n) + linalg_obj.matprod22(yzmat, yzmat_c.');
            ...
            v(:) = ...
                linalg_obj.matprod21(xpt, pq) ...
                - consts_obj.HALF * fortran.sum(pq, 'all') ...
                  * xopt; % This one seems to work better numerically.
            vxopt(:) = ...
                linalg_obj.outprod(v, ...
                                   xopt); %%MATLAB: vxopt = v * xopt';  % v and xopt should be both columns
