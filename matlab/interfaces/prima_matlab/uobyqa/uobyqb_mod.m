classdef uobyqb_mod
    ...
    methods
        function [x, nf, f, fhist, xhist, info] = uobyqb(~, calfun, iprint, maxfun, eta1, eta2, ftarget, gamma1, gamma2, rhobeg, rhoend, x, fhist, xhist, varargin)
            ...
            geometry_uobyqa_obj = geometry_uobyqa_mod();
            initialize_uobyqa_obj = initialize_uobyqa_mod();
            trustregion_uobyqa_obj = trustregion_uobyqa_mod();
            update_uobyqa_obj = update_uobyqa_mod();
